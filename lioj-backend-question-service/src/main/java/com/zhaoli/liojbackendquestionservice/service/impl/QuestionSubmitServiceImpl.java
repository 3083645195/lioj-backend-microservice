package com.zhaoli.liojbackendquestionservice.service.impl;
...
import com.zhaoli.liojbackendcommon.constant.CommonConstant;
import com.zhaoli.liojbackendcommon.exception.BusinessException;
import com.zhaoli.liojbackendcommon.utils.SqlUtils;
...
import com.zhaoli.liojbackendquestionservice.mapper.QuestionSubmitMapper;
...
//        CompletableFuture.runAsync(() -> judgeFeignClient.doJudge(questionSubmitId));
    ...
    /**
     * 获取查询包装类 (用户根据那些字段查询，根据前端传来的请求对象，得到 mybatis 框架支持的查询 QueryRequest 类 )
     *
